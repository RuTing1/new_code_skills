...
#    weights_in = tf.Variable(tf.random_normal([input_size,rnn_unit]))
#    weights_out = tf.Variable(tf.random_normal([rnn_unit,1]))
#    biases_in = tf.Variable(tf.constant(0.1,shape=[rnn_unit,]))
#    biases_out = tf.Variable(tf.constant(0.1,shape=[1,]))
#    
weights={
